...
export const ToggleIconWifi = (props = {}) =>
     Widget.Button({
          ...
          onSecondaryClickRelease: () => {
               execAsync(["bash", "-c", `${userOptions.apps.network}`]).catch(
                    print
               );
               closeEverything();
          },
          ...
          setup: (self) => {
               ...
               self.hook(Network, (button) => {
                    ...
                    button.tooltipText =
                         `${Network.wifi?.ssid} | Right-click to configure` ||
                         "Unknown";
               });
          },
          ...props,
...
export const ToggleIconBluetooth = (props = {}) =>
     Widget.Button({
          ...
          onSecondaryClickRelease: () => {
               execAsync(["bash", "-c", `${userOptions.apps.bluetooth}`]).catch(
                    print
               );
               closeEverything();
          },
     ...
     try {
          return Widget.Button({
               ...
               onClicked: (button) => {
                    ...
                    Utils.execAsync(
                         `hyprctl -j getoption ${hyprlandConfigValue}`
                    )
                         .then((result) => {
                              ...
                              execAsync([
                                   "bash",
                                   "-c",
                                   `hyprctl keyword ${hyprlandConfigValue} ${
                                        1 - currentOption
                                   } &`,
                              ]).catch(print);
                              button.toggleClassName(
               ...
               onClicked: (button) => {
                    ...
                    Hyprland.messageAsync(
                         ...
                         if (shaderPath != "[[EMPTY]]" && shaderPath != "") {
                              ...
                              Hyprland.messageAsync(
                                   `j/keyword decoration:screen_shader /sur/share/sleex-hyprconf/shaders/invert.frag`
                              ).catch(print);
                              button.toggleClassName(
                                   "sidebar-button-active",
                                   true
               ...
               onClicked: (button) => {
                    Hyprland.messageAsync(
                         ...
                         if (value != "[[EMPTY]]" && value != "") {
                              ...
                              Hyprland.messageAsync(
                                   `j/keyword input:accel_profile flat`
                              ).catch(print);
                              button.toggleClassName(
                                   "sidebar-button-active",
                                   true
     ...
     Widget.Button({
          ...
          onClicked: (self) => {
               ...
               if (self.attribute.enabled)
                    ...
                    Utils.execAsync("pkill -f wayland-idle-inhibitor.py").catch(
                         print
                    );
          },
...
export const ModuleDoNotDisturb = (props = {}) =>
     Widget.Button({
          attribute: {
               enabled: false,
          },
          ...
          onClicked: (self) => {
               ...
               if (self.attribute.enabled) {
                    Utils.execAsync([
                         "bash",
                         "-c",
                         `${App.configDir}/ags/scripts/dnd_toggle.sh`,
                    ]).catch(console.error);
               } else {
                    Utils.execAsync([
                         "bash",
...
export const ModuleReloadIcon = (props = {}) =>
     Widget.Button({
          ...props,
          className: "txt-small sidebar-iconbutton sidebar-iconbutton-alt",
