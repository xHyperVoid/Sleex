...
import { chatEntry } from "../../tabs/apiwidgets.js";
     ...
     const providerList = Revealer({
          ...
          child: Box({
               ...
               children: [
                    Box({
                         className:
                              "separator-line margin-top-5 margin-bottom-5",
                    }),
                    Box({
               ...
               (box, id) => {
                    ...
                    box.add(
                         ChatMessage(
                              message,
                              `Model (${
                                   GPTService.providers[GPTService.providerID][
                                        "name"
                                   ]
                              })`
                         )
...
export const sendMessage = (text) => {
     ...
     if (text.startsWith("/")) {
          if (text.startsWith("/clear")) clearChat();
               ...
               chatContent.add(
                    SystemMessage(`Invalid command.`, "Error", chatGPTView)
               );
     } else {
