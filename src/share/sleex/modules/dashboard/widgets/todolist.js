...
const TodoListItem = (task, id, isDone, isEven = false) => {
     ...
     const actions = Box({
          ...
          children: [
               ...
               Widget.Button({
                    ...
                    vpack: "center",
                    className: "txt sidebar-todo-item-action",
                    child: MaterialIcon("delete_forever", "norm", {
                         vpack: "center",
                    }),
                    onClicked: () => {
                         const contentWidth = todoContent.get_allocated_width();
     ...
     const dot = MaterialIcon("trip_origin", "norm");
     const todoContent = Widget.Box({
          className: "sidebar-todo-item spacing-h-5",
          children: [
               Widget.Box({
                    vertical: false,
                    children: [dot, taskName, taskTag, actions],
               }),
               crosser,
          ],
     });
